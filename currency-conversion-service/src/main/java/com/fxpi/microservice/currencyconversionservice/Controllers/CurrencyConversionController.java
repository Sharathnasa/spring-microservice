package com.fxpi.microservice.currencyconversionservice.Controllers;

import com.fxpi.microservice.currencyconversionservice.Beans.CurrencyConversionBean;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversionBean convertCurrency(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity) {
        ...
        assert currencyConversionBean != null;
